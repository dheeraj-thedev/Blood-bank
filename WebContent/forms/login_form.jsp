...
<body id="public">
	<div id="msg">
		<font color="red">Awesome Gallery By Dheeraj Labs</font>
	</div>
	<div id="container" class="ltr"
		style="width: 700px; background-color: ghostWhite">
		...
		<s:form theme="simple" action="Login.Action">
			...
			<ul>
				<li id="foli2" class="notranslate"><label class="desc">
						Enter Username: </label> <s:textfield name="ad.login"
						cssClass="field text ln" size="20" />

					<div id="fieldError">
						<s:fielderror fieldName="ad.login" />
					</div></li>

				<li id="foli2" class="notranslate"><label class="desc">
						Enter Password: </label> <s:password id="Field1" name="ad.password"
						cssClass="field text ln" size="20" /> <!--<s:textfield   name="ad.password"  cssClass="field text ln"  size="20" cssErrorStyle="color:red;" />
...
-->
				...
				<font color="red"> <s:if test="str=='notvalid'">
