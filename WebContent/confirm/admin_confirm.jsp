...
<font color="red">
     <s:if test="str=='updated_staff'">
	                <s:label id="msg"  value="You Updated Staff Member Successfully "></s:label>
	                </s:if>
	         <s:if test="str=='registered_staff'">
	                <s:label value="You Registered Staff Member Successfully "></s:label>
	                </s:if>
	                 <s:if test="str=='deleted_staff'">
	             <s:label value="You Deleted Staff Member Successfully "></s:label>
	                </s:if>
	                <s:if test="str=='event_delete'">
	             <s:label value="You Deleted Event Successfully "></s:label>
	                </s:if>
	                </font>
